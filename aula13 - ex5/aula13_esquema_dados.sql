create schema mac0439ex5;
set search_path to mac0439ex5;
...
insert into batalhas(nome, data) values ('North Atlantic', '5/24/41');
insert into batalhas(nome, data) values ('Guadalacanal', '11/15/42');
insert into batalhas(nome, data) values ('North Cape', '12/26/43');
insert into batalhas(nome, data) values ('Surigao Strait', '10/25/44');
